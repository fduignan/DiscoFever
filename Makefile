...
CCFLAGS=-mcpu=cortex-m4 -mthumb -g -mfloat-abi=hard -fsingle-precision-constant -mfpu=fpv4-sp-d16 -D ARM_MATH_CM4  -D __FPU_PRESENT=1 -O1
...
#-L /usr/local/gcc-arm-none-eabi-5_2-2015q4/arm-none-eabi/lib/fpu/
...
main.elf : $(OBJS)
	$(LD) $(OBJS) $(LIBSPEC) $(LDFLAGS) -lgcc -lm -T linker_script.ld  -nostartfiles -o main.elf
